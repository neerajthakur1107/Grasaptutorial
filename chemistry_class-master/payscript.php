<?php
 ...
 $apiKey = "rzp_live_CQytY20cunFwqJ";
...
<script
    ...
    data-name="Grasptutorials"
    data-description="chemistry coaching"
    data-image="https://grasptutorials.com/images/icon/logo.jpeg"
    data-prefill.name="<?php echo $_POST['name'];?>"
    data-prefill.email="<?php echo $_POST['email'];?>"
    data-prefill.contact="<?php echo $_POST['mobile'];?>"
    data-theme.color="#241571"
></script>
